          ...
          <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
            <form onSubmit={handleSubmit(signUpFormSubmit)}>
              ...
              <div className="flex items-center mt-4">
                <button className="w-full px-4 py-2 tracking-wide bg-gray-900 text-white transition-colors duration-200 transform gray-900 rounded-md  hover:bg-gray-800 focus:outline-none focus:bg-gray-600">
                  Register
                </button>
              </div>
